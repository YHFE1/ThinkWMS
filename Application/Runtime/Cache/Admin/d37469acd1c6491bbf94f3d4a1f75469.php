...
<div id="page-wrapper">
    <form method="post" action="<?php echo U('category/update');?>">
        <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" id="aa" value="<?php echo ($model["name"]); ?>" placeholder="输入分类标题">
        </div>
        
        <div class="form-group">
            <label for="ee">分类别名</label>
            <input type="text" name="name" class="form-control" id="cc" value="<?php echo ($model["title"]); ?>" placeholder="输入分类别名,不能和其他分类别名重复">
        </div>
        <div class="form-group">
